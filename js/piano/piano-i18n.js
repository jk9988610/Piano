const STRINGS = {
  "zh-Hans": {
    ...
    "hint.play": "按住琴键发声；录制后播放将还原时值。",
    "hint.loading": "正在加载 Salamander 钢琴采样（INS-008）…",
  ...
  en: {
    ...
    "hint.play": "Hold keys to play; recording preserves note lengths.",
    "hint.loading": "Loading Salamander piano samples (INS-008)…",
