const STRINGS = {
  "zh-Hans": {
    ...
    "status.playing": "播放中",
    "status.scoreLoaded": "乐谱已就绪 — 点「播放」，在琴键上方看粉/蓝落块矩形",
    "transport.record": "● 录制",
    "transport.stop": "■ 停止",
    "transport.play": "▶ 播放",
    "transport.stopPlay": "⏹ 停止播放",
    "score.open": "♫ 打开乐谱",
    "score.demo.twinkle": "示例：小星星",
    "score.demo.birthday": "示例：生日快乐",
    "score.demo.twoTigers": "示例：两只老虎",
    "score.demo.jasmine": "示例：茉莉花",
    "fullscreen.enter": "全屏",
    ...
    "mode.enjoy": "欣赏模式",
    "mode.practice": "练习模式",
    "mode.enjoyHint": "欣赏模式：矩形中心过线时自动击键",
    "mode.practiceHint": "练习模式：跟随落块矩形手动击键并评分",
    "status.scorePractice": "乐谱已就绪 — 练习模式，点「播放」开始",
    "status.practicePlaying": "练习进行中 — 矩形过线时击键",
  ...
  en: {
    ...
    "status.scoreLoaded": "Score ready — press Play to see pink/blue falling rectangles",
    "transport.record": "● Record",
    "transport.stop": "■ Stop",
    "transport.play": "▶ Play",
    "transport.stopPlay": "⏹ Stop",
    "score.open": "♫ Open score",
    "score.demo.twinkle": "Demo: Twinkle",
    "score.demo.birthday": "Demo: Happy Birthday",
    "score.demo.twoTigers": "Demo: Two Tigers",
    "score.demo.jasmine": "Demo: Jasmine Flower",
    ...
    "mode.enjoyHint": "Enjoy: keys press when a rectangle center crosses the line",
    "mode.practiceHint": "Practice: play along and get Perfect/Good/Miss",
    "status.scorePractice": "Score ready — Practice mode, press Play",
    "status.practicePlaying": "Practicing — hit keys as rectangles cross the line",
